 ...
 */
package org.xtext.example.wh.ide.contentassist.antlr;
...
import org.xtext.example.wh.ide.contentassist.antlr.internal.InternalWHParser;
...
public class WHParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, WHGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getManagerAccess().getNameAssignment_1(), "rule__Manager__NameAssignment_1");
			...
			builder.put(grammarAccess.getAvailabilityAccess().getNameAssignment_1(), "rule__Availability__NameAssignment_1");
