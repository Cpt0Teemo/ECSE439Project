...
public class WHSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	 ...
	 *
	 * Constraint:
	 *     (name=ID startTime=DATE endTime=DATE)
	 */
	protected void sequence_Availability(ISerializationContext context, Availability semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, WHPackage.Literals.AVAILABILITY__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, WHPackage.Literals.AVAILABILITY__NAME));
		...
		feeder.accept(grammarAccess.getAvailabilityAccess().getNameIDTerminalRuleCall_1_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getAvailabilityAccess().getStartTimeDATETerminalRuleCall_3_0(), semanticObject.getStartTime());
		feeder.accept(grammarAccess.getAvailabilityAccess().getEndTimeDATETerminalRuleCall_5_0(), semanticObject.getEndTime());
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (name=ID startDate=DATE endDate=DATE availabilities+=Availability availabilities+=Availability*)
	 */
	 ...
	 *
	 * Constraint:
	 *     (name=ID startDate=DATE endDate=DATE manages=[Team|ID])
	 */
	protected void sequence_Manager(ISerializationContext context, Manager semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, WHPackage.Literals.ROLE__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, WHPackage.Literals.ROLE__NAME));
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getManagerAccess().getNameIDTerminalRuleCall_1_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getManagerAccess().getStartDateDATETerminalRuleCall_2_0(), semanticObject.getStartDate());
		feeder.accept(grammarAccess.getManagerAccess().getEndDateDATETerminalRuleCall_3_0(), semanticObject.getEndDate());
	 ...
	 *
	 * Constraint:
	 *     (name=ID description=STRING assignment=TaskAssignment?)
	 */
