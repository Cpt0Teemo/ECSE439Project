...
public class Main {
	...
	private static void exportXMI(String absuloteTargetFolderPath) {
	    ...
	    Injector injector = new WHStandaloneSetup()
	            .createInjectorAndDoEMFRegistration();
	    XtextResourceSet resourceSet = injector
	            .getInstance(XtextResourceSet.class);

	    // .ext ist the extension of the model file
	    String inputURI = "file:///" + absuloteTargetFolderPath + "/example2.wh";
	    String outputURI = "file:///" + absuloteTargetFolderPath + "/example2.xmi";
